...
b.module("ngResource",["ng"]).provider("$resource",function(){var a=this;this.defaults={stripTrailingSlashes:!0,actions:{get:{method:"GET"},save:{method:"POST"},query:{method:"GET",isArray:!0},remove:{method:"DELETE"},"delete":{method:"DELETE"}}},this.$get=["$http","$q",function(d,h){function i(a){return j(a,!0).replace(/%26/gi,"&").replace(/%3D/gi,"=").replace(/%2B/gi,"+")}function j(a,b){return encodeURIComponent(a).replace(/%40/gi,"@").replace(/%3A/gi,":").replace(/%24/g,"$").replace(/%2C/gi,",").replace(/%20/g,b?"%20":"+")}function k(b,c){this.template=b,this.defaults=o({},a.defaults,c),this.urlParams={}}function l(i,j,r,s){function t(a,b){var c={};return b=o({},j,b),n(b,function(b,d){q(b)&&(b=b()),c[d]=b&&b.charAt&&"@"==b.charAt(0)?e(a,b.substr(1)):b}),c}function u(a){return a.resource}function v(a){f(a||{},this)}var w=new k(i,s);return r=o({},a.defaults.actions,r),v.prototype.toJSON=function(){var a=o({},this);return delete a.$promise,delete a.$resolved,a},n(r,function(a,e){var i=/^(POST|PUT|PATCH)$/i.test(a.method);v[e]=function(j,k,l,r){var s,x,y,z={};switch(arguments.length){case 4:y=r,x=l;case 3:case 2:if(!q(k)){z=j,s=k,x=l;break}if(q(j)){x=j,y=k;break}x=k,y=l;case 1:q(j)?x=j:i?s=j:z=j;break;case 0:break;default:throw g("badargs","Expected up to 4 arguments [params, data, success, error], got {0} arguments",arguments.length)}var A=this instanceof v,B=A?s:a.isArray?[]:new v(s),C={},D=a.interceptor&&a.interceptor.response||u,E=a.interceptor&&a.interceptor.responseError||c;n(a,function(a,b){"params"!=b&&"isArray"!=b&&"interceptor"!=b&&(C[b]=p(a))}),i&&(C.data=s),w.setUrlParams(C,o({},t(s,a.params||{}),z),a.url);var F=d(C).then(function(c){var d=c.data,h=B.$promise;if(d){if(b.isArray(d)!==!!a.isArray)throw g("badcfg","Error in resource configuration for action `{0}`. Expected response to contain an {1} but got an {2} (Request: {3} {4})",e,a.isArray?"array":"object",b.isArray(d)?"array":"object",C.method,C.url);a.isArray?(B.length=0,n(d,function(a){"object"==typeof a?B.push(new v(a)):B.push(a)})):(f(d,B),B.$promise=h)}return B.$resolved=!0,c.resource=B,c},function(a){return B.$resolved=!0,(y||m)(a),h.reject(a)});return F=F.then(function(a){var b=D(a);return(x||m)(b,a.headers),b},E),A?F:(B.$promise=F,B.$resolved=!1,B)},v.prototype["$"+e]=function(a,b,c){q(a)&&(c=b,b=a,a={});var d=v[e].call(this,a,this,b,c);return d.$promise||d}}),v.bind=function(a){return l(i,o({},j,a),r)},v}var m=b.noop,n=b.forEach,o=b.extend,p=b.copy,q=b.isFunction;return k.prototype={setUrlParams:function(a,c,d){var e,f,h=this,j=d||h.template,k=h.urlParams={};n(j.split(/\W/),function(a){if("hasOwnProperty"===a)throw g("badname","hasOwnProperty is not a valid parameter name.");!new RegExp("^\\d+$").test(a)&&a&&new RegExp("(^|[^\\\\]):"+a+"(\\W|$)").test(j)&&(k[a]=!0)}),j=j.replace(/\\:/g,":"),c=c||{},n(h.urlParams,function(a,d){e=c.hasOwnProperty(d)?c[d]:h.defaults[d],b.isDefined(e)&&null!==e?(f=i(e),j=j.replace(new RegExp(":"+d+"(\\W|$)","g"),function(a,b){return f+b})):j=j.replace(new RegExp("(/?):"+d+"(\\W|$)","g"),function(a,b,c){return"/"==c.charAt(0)?c:b+c})}),h.defaults.stripTrailingSlashes&&(j=j.replace(/\/+$/,"")||"/"),j=j.replace(/\/\.(?=\w+($|\?))/,"."),a.url=j.replace(/\/\\\./,"/."),n(c,function(b,c){h.urlParams[c]||(a.params=a.params||{},a.params[c]=b)})}},l}]})}(window,window.angular);var competitieApp=angular.module("competitieApp",["ngRoute","competitieControllers","competitieServices","competitieFilters"]);competitieApp.config(["$routeProvider",function(a){a.when("/competities",{templateUrl:"../angularapps/competitieapp/partials/competities.html",controller:"CompetitiesCtrl",reloadOnSearch:!1}).when("/uitslagen/:competitie",{templateUrl:"../angularapps/competitieapp/partials/uitslagen.html",controller:"UitslagenCtrl",reloadOnSearch:!1}).otherwise({redirectTo:"/competities"})}]);var competitieControllers=angular.module("competitieControllers",[]);competitieControllers.controller("CompetitiesCtrl",["$scope","$http","$location","Competities",function(a,b,c,d){a.competities=d.query({type:"C"}),a.bekers=d.query({type:"K"}),a.geslachtDropdownText="",a.terreinDropdownText="",a.showCompetitie=function(a){c.path("uitslagen/"+a)},a.$watch("selectieType",function(a){search=c.search(),search.type=a,c.search(search)}),a.selectTerrein=function(b,d){a.selectieTerrein=b,a.dropdownMenu="",a.terreinDropdownText=d,search=c.search(),search.indooroutdoor=b,c.search(search).replace()},a.selectGeslacht=function(b,d){a.selectieGeslacht=b,a.dropdownMenu="",a.geslachtDropdownText=d,search=c.search(),search.opendamesmixed=b,c.search(search).replace()},search=c.search(),a.selectieType="K"==search.type?"K":"C",a.selectGeslacht("open"==search.opendamesmixed?"open":"dames"==search.opendamesmixed?"dames":"mixed"==search.opendamesmixed?"mixed":"e","open"==search.opendamesmixed?"Open":"dames"==search.opendamesmixed?"Dames":"mixed"==search.opendamesmixed?"Mixed":"Open/Dames/Mixed"),a.selectTerrein("indoor"==search.indooroutdoor?"indoor":"outdoor"==search.indooroutdoor?"outdoor":"o","indoor"==search.indooroutdoor?"Indoor":"outdoor"==search.indooroutdoor?"Outdoor":"Indoor/Outdoor")}]),competitieControllers.controller("UitslagenCtrl",["$scope","$routeParams","$http","$location","$filter","Klassementen","Wedstrijden","Opzet",function(a,b,c,d,e,f,g,h){a.competitie=b.competitie,a.divisies=[],a.speeldagen=[],a.selectieSpeeldag="",a.selectieDivisie="",a.showSpiritRanking=!0,a.showScorePunten=!0,a.showScoreWedstrijden=!0,a.showScoreVoor=!0,a.showScoreTegen=!0,a.showScoreSpirit=!0,a.filterColumn=function(b){var c=0;for(var d in a.filteredKlassementen)regel=a.filteredKlassementen[d],c+=regel[b];return c>0},a.filterColumns=function(){a.showSpiritRanking=a.filterColumn("ranking_spirit"),a.showScorePunten=a.filterColumn("score_punten"),a.showScoreWedstrijden=a.filterColumn("score_wedstrijden"),a.showScoreVoor=a.filterColumn("score_voor"),a.showScoreTegen=a.filterColumn("score_tegen"),a.showScoreSpirit=a.filterColumn("score_spirit")},a.$watch("selectieSpeeldag",function(b){a.filteredKlassementen=e("divisie")(e("speeldag")(a.klassementen,a.selectieSpeeldag),a.selectieDivisie),a.filteredWedstrijden=e("divisie")(e("speeldag")(a.wedstrijden,a.selectieSpeeldag),a.selectieDivisie),a.filterColumns()}),a.$watch("selectieDivisie",function(b){a.filteredKlassementen=e("divisie")(e("speeldag")(a.klassementen,a.selectieSpeeldag),a.selectieDivisie),a.filteredWedstrijden=e("divisie")(e("speeldag")(a.wedstrijden,a.selectieSpeeldag),a.selectieDivisie),a.filterColumns()}),a.updateSpeeldagen=function(b){a.opzet.some(function(c){return c.divisie==b&&c.speeldag==a.selectieSpeeldag})||a.opzet.some(function(c){return c.divisie==b?(a.selectSpeeldag(c.speeldag),!0):!1})},a.updateDivisies=function(b){a.opzet.some(function(c){return c.speeldag==b&&c.divisie==a.selectieDivisie})||a.opzet.some(function(c){return c.speeldag==b?(a.selectDivisie(c.divisie),!0):!1})},a.selectDivisie=function(b){a.selectieDivisie=b,a.dropdownMenu="",a.divisieDropdownText=""==b?"Alle divisies":"Divisie "+b,search=d.search(),search.divisie=b,d.search(search).replace()},a.selectSpeeldag=function(b){a.selectieSpeeldag=b,a.dropdownMenu="",a.speeldagDropdownText=""==b?"Eindstand":"Speeldag "+b,search=d.search(),search.speeldag=b,d.search(search).replace()},a.naarCompetities=function(){d.path("competities/")},a.klassementen=f.query({competitie:b.competitie},function(b){a.filteredKlassementen=e("divisie")(e("speeldag")(b,a.selectieSpeeldag),a.selectieDivisie),a.filterColumns()}),a.wedstrijden=g.query({competitie:b.competitie},function(b){a.filteredWedstrijden=e("divisie")(e("speeldag")(b,a.selectieSpeeldag),a.selectieDivisie)}),a.opzet=h.query({competitie:b.competitie},function(b){angular.forEach(b,function(b,c){-1==$.inArray(b.divisie,a.divisies)&&a.divisies.push(b.divisie),-1==$.inArray(b.speeldag,a.speeldagen)&&a.speeldagen.push(b.speeldag)}),search=d.search(),a.selectieType="K"==search.type?"K":"C",a.selectSpeeldag(a.speeldagen.indexOf(search.speeldag)>=0?search.speeldag:a.speeldagen[0]),a.selectDivisie(a.divisies.indexOf(search.divisie)>=0?search.divisie:a.divisies[0]),a.updateSpeeldagen(a.selectieDivisie)})}]);var competitieFilters=angular.module("competitieFilters",[]);competitieFilters.filter("geslacht",function(){return function(a,b){var c=[];return angular.forEach(a,function(a){a.geslacht.toLowerCase().indexOf(b.toLowerCase())>=0&&c.push(a)}),c}}),competitieFilters.filter("terrein",function(){return function(a,b){var c=[];return angular.forEach(a,function(a){a.terrein.toLowerCase().indexOf(b.toLowerCase())>=0&&c.push(a)}),c}}),competitieFilters.filter("divisie",function(){return function(a,b){var c=[];return""==b?angular.forEach(a,function(a){""==a.divisie&&c.push(a)}):angular.forEach(a,function(a){a.divisie.toLowerCase().indexOf(b.toLowerCase())>=0&&c.push(a)}),c}}),competitieFilters.filter("speeldag",function(){return function(a,b){var c=[];return""==b?angular.forEach(a,function(a){""==a.speeldag&&c.push(a)}):angular.forEach(a,function(a){a.speeldag.toLowerCase().indexOf(b.toLowerCase())>=0&&c.push(a)}),c}});var competitieServices=angular.module("competitieServices",["ngResource"]);competitieServices.factory("Competities",["$resource",function(a){return a("/competitie/public/competities/",{},{query:{method:"GET",params:{},isArray:!0}})}]),competitieServices.factory("Klassementen",["$resource",function(a){return a("/competitie/public/klassementen/:competitie",{},{query:{method:"GET",params:{},isArray:!0}})}]),competitieServices.factory("Wedstrijden",["$resource",function(a){return a("/competitie/public/wedstrijden/:competitie",{},{query:{method:"GET",params:{},isArray:!0}})}]),competitieServices.factory("Opzet",["$resource",function(a){return a("/competitie/public/opzet/:competitie",{},{query:{method:"GET",params:{},isArray:!0}})}]);